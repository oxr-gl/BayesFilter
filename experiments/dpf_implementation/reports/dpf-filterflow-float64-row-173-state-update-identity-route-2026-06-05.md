...
FilterFlow identity residuals are clean while BayesFilter identity residuals are material

## Decision Table

| Decision | Primary criterion status | Veto diagnostic status | Main uncertainty | Next justified action | Not concluded |
| --- | --- | --- | --- | --- | --- |
| filterflow_float64_row_173_state_update_identity_route_bayesfilter_identity_residual | h2_bayesfilter_identity_residual_filterflow_identity_clean | {"all_vetoes_clear": true, "comparator_drift": false, "cpu_only_pass": true, "identity_tensors_finite": true, "path_boundary_clean": true, "path_boundary_manifest": {"dsge_nawm_code_used": false, "filterflow_source_mutated": false, "highdim_lane_used_or_edited": false, "monograph_chapters_used_or_edited": false, "production_bayesfilter_code_used": false, "student_or_vendored_code_used_as_authority": false, "tests_code_used": false}, "reference_status_validated": true, "required_identity_tensors_present": true, "resampling_flags_match": true, "scalar_gate_pass": true, "value_path_gate_pass": true} | single row and target time; no correctness claim | inspect BayesFilter tape boundaries for carried state/log-weight identity routing | correctness, posterior correctness, production readiness, global agreement |
...
```json
{
  ...
  "classification_reason": "FilterFlow identity residuals are clean while BayesFilter identity residuals are material",
  "cross_side_identity_rows": {
    "direct_pre_particle_adjoint": {
      "bayesfilter_max_abs": 0.032745181880207294,
      "field": "direct_pre_particle_adjoint",
      "filterflow_max_abs": 0.03274518187397153,
      "gradient_tolerance": 0.0002,
      "material_cross_delta": false,
    ...
    "same_tape_log_ess_carryover_vjp": {
      ...
      "field": "same_tape_log_ess_carryover_vjp",
    ...
    "same_tape_post_log_weights_vjp": {
      "bayesfilter_max_abs": 0.0,
      "field": "same_tape_post_log_weights_vjp",
      "filterflow_max_abs": 0.0,
      "gradient_tolerance": 0.0002,
      "material_cross_delta": false,
      "max_abs_delta": 0.0,
    ...
    "same_tape_post_particles_vjp": {
      ...
      "field": "same_tape_post_particles_vjp",
    ...
    "same_tape_post_state_vjp": {
      "bayesfilter_max_abs": 15.33929208686093,
      "field": "same_tape_post_state_vjp",
      "filterflow_max_abs": 1.075538971836846,
      "gradient_tolerance": 0.0002,
      "material_cross_delta": true,
      "max_abs_delta": 15.290311581913166,
    ...
    "same_tape_reconstructed_pre_particle_adjoint": {
      "bayesfilter_max_abs": 15.33929208686093,
      "field": "same_tape_reconstructed_pre_particle_adjoint",
      "filterflow_max_abs": 1.075538971836846,
      "gradient_tolerance": 0.0002,
      "material_cross_delta": true,
    ...
    "same_tape_transport_matrix_vjp": {
      ...
      "field": "same_tape_transport_matrix_vjp",
  ...
  "downstream_prior_classification": "h2_local_official_match_not_global_route",
  "downstream_prior_decision": "filterflow_float64_row_173_downstream_adjoint_route_local_match_not_global",
  ...
  "material_filterflow_identities": [],
  ...
  "within_side_identity_rows": {
    "bayesfilter": {
      "same_tape_full_recorded_state_identity": {
        "clean": false,
        "finite": true,
        "gradient_tolerance": 0.0002,
        "identity": "same_tape_full_recorded_state_identity",
        "material": true,
        "max_abs": 15.29031158182802,
        "residual_field": "same_tape_full_recorded_state_residual",
      ...
      "same_tape_identity": {
        ...
        "finite": true,
        "gradient_tolerance": 0.0002,
        "identity": "same_tape_identity",
        "material": true,
        "max_abs": 0.6735763083742867,
        "residual_field": "same_tape_identity_residual",
      ...
      "same_tape_post_state_identity": {
        ...
        "finite": true,
        "gradient_tolerance": 0.0002,
        "identity": "same_tape_post_state_identity",
        "material": true,
        "max_abs": 0.6735763083742867,
        "residual_field": "same_tape_post_state_identity_residual",
...
{
  "T": 100,
  "artifact_tag": "row-173-state-update-identity-route",
  "batch_size": 1,
  ...
  "epsilon": 0.25,
  "filter_seed": 1234,
  "identity_gradient_tolerance": 0.0002,
  "identity_keys": [
    "same_tape_identity",
    "same_tape_post_state_identity",
    "same_tape_full_recorded_state_identity"
  ],
  "identity_value_tolerance": 5e-08,
  "max_iter": 500,
  "mesh_index": 173,
...
{
  "branch": "main",
  "command": "CUDA_VISIBLE_DEVICES=-1 python -m experiments.dpf_implementation.tf_tfp.runners.run_filterflow_float64_row_173_state_update_identity_route_tf",
  ...
  "gpu_devices_visible": [],
  "json_path": "/home/chakwong/BayesFilter/experiments/dpf_implementation/reports/outputs/dpf_filterflow_float64_row_173_state_update_identity_route_2026-06-05.json",
  "package_versions": {
    "tensorflow": "2.19.1",
    "tensorflow_probability": "0.25.0"
  },
  "plan_path": "docs/plans/bayesfilter-dpf-filterflow-float64-row-173-state-update-identity-route-plan-2026-06-05.md",
  "pre_import_cuda_visible_devices": "-1",
  "python_version": "3.11.14",
  "report_path": "/home/chakwong/BayesFilter/experiments/dpf_implementation/reports/dpf-filterflow-float64-row-173-state-update-identity-route-2026-06-05.md",
  "result_path": "docs/plans/bayesfilter-dpf-filterflow-float64-row-173-state-update-identity-route-result-2026-06-05.md",
  "target_time_index": 93,
  "wall_time_seconds": 293.38636674103327
}
```
...
`ff6b7ac7f2646b502b736d1d71d74f6f879cf14d3590dad6f89d4d5ade8857f6`
