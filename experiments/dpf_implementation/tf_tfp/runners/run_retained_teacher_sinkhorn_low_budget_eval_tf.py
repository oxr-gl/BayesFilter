"""Run low-budget heldout evaluation for retained-teacher Sinkhorn warm-start versus zero-init."""
...
JSON_PATH = OUTPUT_DIR / "retained_teacher_sinkhorn_low_budget_eval_2026-06-18.json"
REPORT_PATH = REPORT_DIR / "retained-teacher-sinkhorn-low-budget-eval-2026-06-18.md"
RESULT_PATH = "docs/plans/bayesfilter-neural-ot-retained-teacher-low-budget-eval-result-2026-06-18.md"
PLAN_PATH = "docs/plans/bayesfilter-neural-ot-retained-teacher-low-budget-eval-plan-2026-06-18.md"
SCALAR_ID = "retained_teacher_sinkhorn_low_budget_teacher_cloud_fidelity_tf"
...
EXPECTED_DECISION = "RETAINED_TEACHER_SINKHORN_LOW_BUDGET_EVAL_PASSED"
...
def _run() -> dict[str, Any]:
    ...
    if scalar(final_train_loss) >= scalar(initial_train_loss):
        decision = "RETAINED_TEACHER_SINKHORN_LOW_BUDGET_EVAL_FAILED"
    ...
    payload = {
        "decision": decision,
        "question": "At low corrective budgets, does student-warm-started retained Sinkhorn match or improve heldout teacher-cloud fidelity relative to zero-init?",
        ...
        "run_manifest": environment_manifest(
            command="CUDA_VISIBLE_DEVICES=-1 python -m experiments.dpf_implementation.tf_tfp.runners.run_retained_teacher_sinkhorn_low_budget_eval_tf",
