"""Generate a modestly strengthened retained-teacher Sinkhorn teacher-data artifact on Austria SIR d18 clouds."""
...
JSON_PATH = OUTPUT_DIR / "retained_teacher_sinkhorn_teacher_data_austria_sir_d18_expanded_2026-07-05.json"
REPORT_PATH = REPORT_DIR / "retained-teacher-sinkhorn-teacher-data-austria-sir-d18-expanded-2026-07-05.md"
...
RESULT_PATH = "docs/plans/bayesfilter-neural-ot-austria-sir-d18-retained-teacher-expanded-teacher-data-result-2026-07-05.md"
TRAIN_SEEDS = (111, 222, 555, 666)
HELDOUT_SEEDS = (333, 444, 777, 888)
NUM_PARTICLES = 64
...
EXPECTED_DECISION = "RETAINED_TEACHER_SINKHORN_TEACHER_DATA_AUSTRIA_SIR_D18_EXPANDED_READY"
...
def _run() -> dict[str, Any]:
    ...
    decision = EXPECTED_DECISION if _all_examples_finite(examples) and examples else "RETAINED_TEACHER_SINKHORN_TEACHER_DATA_AUSTRIA_SIR_D18_EXPANDED_FAILED"
    ...
    payload = {
        "decision": decision,
        "question": "Can BayesFilter generate a modestly strengthened retained-teacher Sinkhorn latent artifact on Austria SIR d18 weighted clouds?",
        ...
        "run_manifest": environment_manifest(
            command="CUDA_VISIBLE_DEVICES=-1 python -m experiments.dpf_implementation.tf_tfp.runners.run_retained_teacher_sinkhorn_teacher_data_austria_sir_d18_expanded_tf",
...
def _validate_payload(payload: dict[str, Any]) -> None:
    ...
    if payload["counts"]["heldout_examples"] <= 0:
        raise RuntimeError("expanded teacher-data payload captured no heldout examples")
...
def _markdown(payload: dict[str, Any]) -> str:
    return f"""# Austria SIR d18 Expanded Retained-Teacher Teacher-Data Result
