...
python docs/benchmarks/benchmark_p8p_regression_fd_reparameterization.py \
  --phase-label "SIR budget10 physics reparameterization diagnostic" \
  ...
  --progress-output docs/plans/bayesfilter-ledh-pfpf-ot-sir-gradient-reparam-physics-budget10-progress-2026-07-01.json \
  --output docs/plans/bayesfilter-ledh-pfpf-ot-sir-gradient-reparam-physics-budget10-2026-07-01.json
