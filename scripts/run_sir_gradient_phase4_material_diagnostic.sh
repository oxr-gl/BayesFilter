...
python docs/benchmarks/diagnose_p8p_sir_sinkhorn_budget.py \
  ...
  --progress-output docs/plans/bayesfilter-ledh-pfpf-ot-sir-gradient-hmc-direction-phase4-material-gradient-diagnostic-progress-2026-06-30.json \
  --output docs/plans/bayesfilter-ledh-pfpf-ot-sir-gradient-hmc-direction-phase4-material-gradient-diagnostic-2026-06-30.json \
