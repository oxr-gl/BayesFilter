...
python docs/benchmarks/diagnose_p8p_sir_sinkhorn_budget.py \
  ...
  --progress-output docs/plans/bayesfilter-ledh-pfpf-ot-sir-gradient-hmc-direction-phase5-budget100-progress-2026-06-30.json \
  --output docs/plans/bayesfilter-ledh-pfpf-ot-sir-gradient-hmc-direction-phase5-budget100-2026-06-30.json \
  --markdown-output docs/plans/bayesfilter-ledh-pfpf-ot-sir-gradient-hmc-direction-phase5-budget100-2026-06-30.md
