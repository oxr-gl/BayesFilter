...
- JSON artifact: `docs/plans/bayesfilter-ledh-inclusive-highdim-leaderboard-phase4-lgssm-m3-t50-same-target-value-ladder-N10000-2026-07-03.json`
...
- Shape: `{'batch_size': 5, 'batch_seed_count': 5, 'time_steps': 50, 'num_particles': 10000, 'state_dim': 3, 'obs_dim': 3}`
...
- Compile plus first call seconds: `27.142047179979272`
- Warm-call timing summary seconds: `{'min': 15.810666500008665, 'median': 15.810666500008665, 'mean': 15.810666500008665, 'max': 15.810666500008665}`
- Total log likelihood mean: `-135.96007385253907`
- Total log likelihood SD: `0.013267499979632216`
- Total log likelihood MCSE: `0.005933406369186942`
- Average log likelihood mean: `-2.719201477050781`
- Average log likelihood MCSE: `0.00011866812738375645`
- Exact Kalman total log likelihood: `-136.0759748579247`
- Exact Kalman average log likelihood: `-2.721519497158494`
- Average delta to exact: `0.0023180201077130924`
