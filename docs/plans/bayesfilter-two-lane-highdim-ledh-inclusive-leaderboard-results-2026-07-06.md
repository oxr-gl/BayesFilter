...
Authoritative JSON artifact: `docs/plans/bayesfilter-two-lane-highdim-ledh-inclusive-leaderboard-results-2026-07-06.json`.
...
| benchmark_lgssm_exact_oracle_m3_T50 | ledh_pfpf_ot | executed_value_score | -2.7192 | 0.000118668 | admitted_same_target_no_tape_score_n10000 | False | same-target LEDH value and no-tape score executed at N=10000 |
...
| zhao_cui_spatial_sir_austria_j9_T20 | ledh_pfpf_ot | executed_value_score | -45.1415 | 0.0104111 | admitted_same_target_no_tape_score_n10000 | False | fixed spatial SIR LEDH value and no-tape score executed at N=10000 under the amended sir_log_scale_theta row |
...
| --- | --- | --- | --- | --- | --- |
| benchmark_lgssm_exact_oracle_m3_T50 | executed_value_score | executed_same_target_value | admitted_same_target_no_tape_score_n10000 | True | True |
...
| zhao_cui_spatial_sir_austria_j9_T20 | executed_value_score | executed_fixed_sir_value_only | admitted_same_target_no_tape_score_n10000 | False | False |
