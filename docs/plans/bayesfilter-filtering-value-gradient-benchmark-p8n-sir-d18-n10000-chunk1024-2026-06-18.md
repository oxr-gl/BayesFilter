...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8n-sir-d18-n10000-chunk1024-2026-06-18.json`
...
- History mode: `full`
- Compile plus first call seconds: `21.79888132819906`
- Warm-call timing summary seconds: `{'min': 8.460080001037568, 'median': 8.629158840049058, 'mean': 8.629158840049058, 'max': 8.798237679060549}`
- Speedup vs scalar comparator: `91.52174373412161`
- Finite output: `True`
