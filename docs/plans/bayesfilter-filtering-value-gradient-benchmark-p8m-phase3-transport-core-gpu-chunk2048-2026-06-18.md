...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8m-phase3-transport-core-gpu-chunk2048-2026-06-18.json`
...
- Transport: `{'plan_mode': 'streaming', 'gradient_mode': 'raw', 'row_chunk_size': 2048, 'col_chunk_size': 2048, 'sinkhorn_iterations': 10, 'sinkhorn_epsilon': 1.0, 'annealed_scaling': 0.9, 'annealed_convergence_threshold': 0.001, 'dense_transport_matrix_materialized': False}`
- Compile plus first call seconds: `5.234392670914531`
- Warm-call timing summary seconds: `{'min': 0.2889336789958179, 'median': 0.2957250664476305, 'mean': 0.2957250664476305, 'max': 0.30251645389944315}`
- Finite output: `True`
