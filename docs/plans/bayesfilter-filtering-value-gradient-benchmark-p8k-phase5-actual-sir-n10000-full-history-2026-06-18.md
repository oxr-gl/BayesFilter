...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8k-phase5-actual-sir-n10000-full-history-2026-06-18.json`
...
- History mode: `full`
- Compile plus first call seconds: `19.849983410909772`
- Warm-call timing summary seconds: `{'min': 6.898784074932337, 'median': 6.898784074932337, 'mean': 6.898784074932337, 'max': 6.898784074932337}`
- Speedup vs scalar comparator: `114.47751595381624`
- Finite output: `True`
