...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8k-phase5-actual-sir-n10000-value-only-2026-06-18.json`
...
- Compile plus first call seconds: `20.708216819912195`
- Warm-call timing summary seconds: `{'min': 7.100296164862812, 'median': 7.100296164862812, 'mean': 7.100296164862812, 'max': 7.100296164862812}`
- Speedup vs scalar comparator: `111.22855239592099`
- Finite output: `True`
