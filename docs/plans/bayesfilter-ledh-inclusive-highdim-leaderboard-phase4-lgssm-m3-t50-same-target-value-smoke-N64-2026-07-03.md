...
- JSON artifact: `docs/plans/bayesfilter-ledh-inclusive-highdim-leaderboard-phase4-lgssm-m3-t50-same-target-value-smoke-N64-2026-07-03.json`
...
- Shape: `{'batch_size': 5, 'batch_seed_count': 5, 'time_steps': 50, 'num_particles': 64, 'state_dim': 3, 'obs_dim': 3}`
...
- Compile plus first call seconds: `9.89594420499634`
- Warm-call timing summary seconds: `{'min': 0.6527155409567058, 'median': 0.6527155409567058, 'mean': 0.6527155409567058, 'max': 0.6527155409567058}`
- Total log likelihood mean: `-136.3683654785156`
- Total log likelihood SD: `0.3523109185888762`
- Total log likelihood MCSE: `0.15755823263602428`
- Average log likelihood mean: `-2.7273673095703126`
- Average log likelihood MCSE: `0.003151164652720498`
- Exact Kalman total log likelihood: `-136.0759748579247`
- Exact Kalman average log likelihood: `-2.721519497158494`
- Average delta to exact: `-0.0058478124118184205`
- Average relative error: `0.0021487306697321297`
- Finite output: `True`
