...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8j-tf32-batched-proxy-sirshape-b5-n64-gpu-2026-06-17.json`
- Shape: `{'batch_size': 5, 'time_steps': 20, 'num_particles': 64, 'state_dim': 18, 'obs_dim': 9}`
...
- Compile plus first call seconds: `8.397600126918405`
- Warm-call timing summary seconds: `{'min': 0.23850369825959206, 'median': 0.25611949199810624, 'mean': 0.25314160871009034, 'max': 0.26480163587257266}`
- Finite output: `True`
