...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8j-tf32-batched-actual-sir-n10000-b1-probe-2026-06-17.json`
- Row: `zhao_cui_spatial_sir_austria_j9_T20`
- Shape: `{'batch_size': 1, 'batch_seed_count': 1, 'time_steps': 20, 'num_particles': 10000, 'state_dim': 18, 'obs_dim': 9}`
...
- Compile plus first call seconds: `17.15657041501254`
- Warm-call timing summary seconds: `{'min': 4.972724597901106, 'median': 4.972724597901106, 'mean': 4.972724597901106, 'max': 4.972724597901106}`
- Speedup vs scalar comparator: `158.81749500733284`
- Finite output: `True`
