...
- all 48 cells are terminally classified;
- no oracle claim, FD gate, proxy student panel, or unreviewed contract
  weakening was found;
- CPU-only TensorFlow hiding was set before import and recorded;
- the two APF executed mismatches are concrete explained mismatches;
- interface-blocked cells are not treated as student failures.
