...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8j-tf32-batched-actual-sir-n50000-b5-probe-2026-06-17.json`
...
- Compile plus first call seconds: `171.2960470081307`
- Warm-call timing summary seconds: `{'min': 163.35498285200447, 'median': 163.35498285200447, 'mean': 163.35498285200447, 'max': 163.35498285200447}`
- Speedup vs scalar comparator: `4.834597942540259`
- Finite output: `True`
