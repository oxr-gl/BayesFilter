...
- Compile plus first call seconds: `7.706783903064206`
- Warm-call timing summary seconds: `{'min': 0.017889288952574134, 'median': 0.017889288952574134, 'mean': 0.017889288952574134, 'max': 0.017889288952574134}`
- Total log likelihood mean: `-11.019298553466797`
- Total log likelihood SD: `None`
- Total log likelihood MCSE: `None`
- Average log likelihood mean: `-5.509649276733398`
- Average log likelihood MCSE: `None`
- Exact Kalman total log likelihood: `-8.862150494354598`
- Exact Kalman average log likelihood: `-4.431075247177299`
- Average delta to exact: `-1.0785740295560995`
- Average relative error: `0.24341135489476892`
- Finite output: `True`
