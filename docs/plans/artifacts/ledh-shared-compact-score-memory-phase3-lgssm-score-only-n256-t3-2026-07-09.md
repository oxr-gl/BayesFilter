...
- Shape: `{'batch_size': 1, 'batch_seed_count': 1, 'time_steps': 3, 'num_particles': 256, 'state_dim': 3, 'obs_dim': 3}`
...
- Compile plus first call seconds: `9.844050382031128`
- Warm-call timing summary seconds: `{'min': 0.09349646815098822, 'median': 0.09349646815098822, 'mean': 0.09349646815098822, 'max': 0.09349646815098822}`
- Total log likelihood mean: `-13.118598937988281`
- Total log likelihood SD: `None`
- Total log likelihood MCSE: `None`
- Average log likelihood mean: `-4.372866312662761`
- Average log likelihood MCSE: `None`
- Exact Kalman total log likelihood: `-12.843525321502067`
- Exact Kalman average log likelihood: `-4.281175107167356`
- Average delta to exact: `-0.09169120549540466`
- Average relative error: `0.02141729856877362`
- Finite output: `True`
