...
- Shape: `{'batch_size': 1, 'batch_seed_count': 1, 'time_steps': 10, 'num_particles': 1000, 'state_dim': 3, 'obs_dim': 3}`
...
- Compile plus first call seconds: `9.13870816398412`
- Warm-call timing summary seconds: `{'min': 0.33176424191333354, 'median': 0.33176424191333354, 'mean': 0.33176424191333354, 'max': 0.33176424191333354}`
- Total log likelihood mean: `-32.26648712158203`
- Total log likelihood SD: `None`
- Total log likelihood MCSE: `None`
- Average log likelihood mean: `-3.226648712158203`
...
- Average delta to exact: `-0.0213871656228517`
- Average relative error: `0.0066725180807693`
- Finite output: `True`
