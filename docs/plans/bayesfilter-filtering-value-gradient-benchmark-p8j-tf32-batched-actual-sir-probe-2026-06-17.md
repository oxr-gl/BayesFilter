...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8j-tf32-batched-actual-sir-probe-2026-06-17.json`
- Row: `zhao_cui_spatial_sir_austria_j9_T20`
- Shape: `{'batch_size': 5, 'batch_seed_count': 5, 'time_steps': 20, 'num_particles': 64, 'state_dim': 18, 'obs_dim': 9}`
...
- Compile plus first call seconds: `13.474980568978935`
- Warm-call timing summary seconds: `{'min': 0.1629901621490717, 'median': 0.16590180969797075, 'mean': 0.16590180969797075, 'max': 0.1688134572468698}`
- Speedup vs scalar comparator: `4760.380043097625`
- Finite output: `True`
