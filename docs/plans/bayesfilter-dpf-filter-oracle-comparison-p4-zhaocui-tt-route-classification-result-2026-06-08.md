...
phase: P4
status: PASS_P4_ZHAOCUI_ROUTE_CLASSIFICATION_PENDING_CLAUDE_REVIEW
...
| Field | Contract |
| --- | --- |
| Question | For every P0 target, what master claim class should the Zhao-Cui/fixed-design TT route carry, and is P5 eligibility known without promoting diagnostics, fit residuals, or blocked multistate rows? |
| Baseline/comparator | P0 registry plus reviewed P1 LGSSM, P2 dense nonlinear, P3 transformed/mixture, P44 tiny nonlinear, and P45 blocker artifacts |
| Primary criterion | all P0 targets have exactly one Zhao-Cui/fixed-design TT row classified in the master schema with evidence source or blocker, phase eligibility, branch metadata, and P5 readiness |
| Execution amendment | P4 uses a pure-Python registry/artifact validator because the phase question is route classification; TensorFlow reruns are not the primary evidence |
| Gradient policy | gradient-bearing Zhao-Cui rows are fixed-branch scores only and require same-target value evidence before interpretation |
...
| Diagnostic | Status |
| --- | --- |
| `missing_zhao_cui_row` | `False` |
| `invalid_claim_class` | `False` |
| `scalar_only_route_applied_to_multistate_without_adapter` | `False` |
| `adaptive_fit_hidden_inside_fixed_branch_claim` | `False` |
| `fit_residual_promoted_to_likelihood_correctness` | `False` |
| `zhao_cui_treated_as_exact_oracle` | `False` |
| `runnable_row_lacks_value_evidence` | `False` |
| `gradient_row_without_same_target_value_evidence` | `False` |
| `blocked_row_lacks_blocker` | `False` |
| `p5_eligibility_unknown` | `False` |
...
| --- | --- |
| row count | `13` |
| claim class counts | `{'BLOCKED': 8, 'CERTIFIED_APPROXIMATION': 4, 'DIAGNOSTIC_ONLY': 1, 'EXACT_ORACLE': 0, 'SURROGATE_USEFULNESS': 0}` |
| runnable/diagnostic rows | `['lgssm_2d_h25_rich', 'p44_m2_cubic_additive_gaussian_panel', 'p44_m3_quadratic_observation_panel', 'p44_m4_nonlinear_transition_h2_panel', 'sv_exact_transformed_log_chi_square_panel']` |
| blocked rows | `['sv_ksc_transformed_mixture_panel', 'generalized_sv_native_raw_observation', 'generalized_sv_transformed_residual_diagnostic', 'generalized_sv_gaussian_mixture_or_moment_matched_approximation', 'spatial_sir_additive_gaussian_closure', 'spatial_sir_native_or_nongaussian_route', 'predator_prey_additive_gaussian_rk4_closure', 'predator_prey_native_or_nongaussian_route']` |
| P5 DPF eligible targets | `['lgssm_2d_h25_rich', 'p44_m2_cubic_additive_gaussian_panel', 'p44_m3_quadratic_observation_panel', 'p44_m4_nonlinear_transition_h2_panel']` |

## Rows

| target | class | P4 | P5 DPF | evidence class | P5 reference |
| --- | --- | --- | --- | --- | --- |
| `lgssm_2d_h25_rich` | `DIAGNOSTIC_ONLY` | `True` | `True` | `auxiliary_kalman_sanity_diagnostic_only` | `kalman_exact` |
| `p44_m2_cubic_additive_gaussian_panel` | `CERTIFIED_APPROXIMATION` | `True` | `True` | `p2_same_target_dense_certificate` | `dense_refined_quadrature` |
| `p44_m3_quadratic_observation_panel` | `CERTIFIED_APPROXIMATION` | `True` | `True` | `p44_dense_stress_certificate` | `dense_refined_quadrature` |
| `p44_m4_nonlinear_transition_h2_panel` | `CERTIFIED_APPROXIMATION` | `True` | `True` | `p44_dense_h2_certificate` | `dense_refined_quadrature` |
| `sv_exact_transformed_log_chi_square_panel` | `CERTIFIED_APPROXIMATION` | `True` | `False` | `p3_exact_transformed_dense_certificate` | `none` |
| `sv_ksc_transformed_mixture_panel` | `BLOCKED` | `False` | `False` | `blocked_preserved_from_p0_p45` | `none` |
| `generalized_sv_native_raw_observation` | `BLOCKED` | `False` | `False` | `blocked_preserved_from_p0_p45` | `none` |
| `generalized_sv_transformed_residual_diagnostic` | `BLOCKED` | `False` | `False` | `blocked_preserved_from_p0_p45` | `none` |
| `generalized_sv_gaussian_mixture_or_moment_matched_approximation` | `BLOCKED` | `False` | `False` | `blocked_preserved_from_p0_p45` | `none` |
| `spatial_sir_additive_gaussian_closure` | `BLOCKED` | `False` | `False` | `blocked_preserved_from_p0_p45` | `none` |
| `spatial_sir_native_or_nongaussian_route` | `BLOCKED` | `False` | `False` | `blocked_preserved_from_p0_p45` | `none` |
| `predator_prey_additive_gaussian_rk4_closure` | `BLOCKED` | `False` | `False` | `blocked_preserved_from_p0_p45` | `none` |
| `predator_prey_native_or_nongaussian_route` | `BLOCKED` | `False` | `False` | `blocked_preserved_from_p0_p45` | `none` |
...
| --- | --- | --- | --- | --- | --- |
| `PASS_P4_ZHAOCUI_ROUTE_CLASSIFICATION_PENDING_CLAUDE_REVIEW` | all `13` P0 targets classified; claim counts `{'BLOCKED': 8, 'CERTIFIED_APPROXIMATION': 4, 'DIAGNOSTIC_ONLY': 1, 'EXACT_ORACLE': 0, 'SURROGATE_USEFULNESS': 0}` | `{'missing_zhao_cui_row': False, 'invalid_claim_class': False, 'scalar_only_route_applied_to_multistate_without_adapter': False, 'adaptive_fit_hidden_inside_fixed_branch_claim': False, 'fit_residual_promoted_to_likelihood_correctness': False, 'zhao_cui_treated_as_exact_oracle': False, 'runnable_row_lacks_value_evidence': False, 'gradient_row_without_same_target_value_evidence': False, 'blocked_row_lacks_blocker': False, 'p5_eligibility_unknown': False}` | P4 is classification-only and relies on reviewed source artifacts | run Claude read-only P4 gate review | no DPF correctness or paper-scale/adaptive/coupled TT claim |
...
- command: `python -m experiments.dpf_implementation.tf_tfp.runners.run_filter_oracle_comparison_p4_zhaocui_tt_route_classification_tf`
- git branch: `main`
...
- CPU/GPU status: `pure_python_classification_only; TensorFlow not imported; no GPU claim`
- plan: `docs/plans/bayesfilter-dpf-filter-oracle-comparison-p4-zhaocui-tt-route-classification-subplan-2026-06-08.md`
- review ledger: `docs/plans/bayesfilter-dpf-filter-oracle-comparison-p4-claude-review-ledger-2026-06-08.md`
- JSON: `experiments/dpf_implementation/reports/outputs/dpf_filter_oracle_comparison_p4_zhaocui_tt_route_classification_2026-06-08.json`
- report: `experiments/dpf_implementation/reports/dpf-filter-oracle-comparison-p4-zhaocui-tt-route-classification-2026-06-08.md`
- result: `docs/plans/bayesfilter-dpf-filter-oracle-comparison-p4-zhaocui-tt-route-classification-result-2026-06-08.md`
- wall time seconds: `0.009897244162857533`
