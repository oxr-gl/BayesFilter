...
- JSON artifact: `docs/plans/bayesfilter-ledh-inclusive-highdim-leaderboard-phase3-fixed-sir-gpu-xla-value-smoke-2026-07-03.json`
- Row: `zhao_cui_spatial_sir_austria_j9_T20`
- Shape: `{'batch_size': 2, 'batch_seed_count': 2, 'time_steps': 1, 'num_particles': 16, 'state_dim': 18, 'obs_dim': 9}`
...
- Compile plus first call seconds: `8.678175200009719`
- Warm-call timing summary seconds: `{'min': 0.006106611923314631, 'median': 0.006106611923314631, 'mean': 0.006106611923314631, 'max': 0.006106611923314631}`
- Speedup vs scalar comparator: `129327.96023679945`
- Finite output: `True`
