...
Authoritative JSON artifact: `docs/plans/bayesfilter-two-lane-highdim-ledh-inclusive-leaderboard-results-2026-07-03.json`.
...
| benchmark_lgssm_exact_oracle_m3_T50 | ledh_pfpf_ot | executed_value_only_score_blocked | -2.7192 | 0.000118668 | blocked_score_same_target_total_derivative_not_implemented | False | same-target LEDH value executed at N=10000; score remains blocked |
...
| zhao_cui_spatial_sir_austria_j9_T20 | ledh_pfpf_ot | executed_value_only_score_blocked | -45.1415 | 0.0104111 | blocked_score_for_full_leaderboard_row | False | fixed spatial SIR LEDH value executed at N=10000; score remains blocked |
...
| --- | --- | --- | --- | --- | --- |
| benchmark_lgssm_exact_oracle_m3_T50 | executed_value_only_score_blocked | executed_same_target_value | blocked_score_same_target_total_derivative_not_implemented | True | False |
...
| zhao_cui_spatial_sir_austria_j9_T20 | executed_value_only_score_blocked | executed_fixed_sir_value_only | blocked_score_for_full_leaderboard_row | False | False |
