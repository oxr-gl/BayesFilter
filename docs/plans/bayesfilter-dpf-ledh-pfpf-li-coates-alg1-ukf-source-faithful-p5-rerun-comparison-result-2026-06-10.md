...
phase: P5
status: PASS_P5_LGSSM_ALG1_UKF_BOUNDED_DIAGNOSTICS_PENDING_CLAUDE_REVIEW
...
| `gradient_smoke_nonfinite` | `False` |
| `missing_value_monte_carlo_uncertainty` | `False` |
| `gradient_smoke_mislabeled_stochastic_score` | `False` |
| `old_ledh_pfpf_ot_used_as_algorithm1_evidence` | `False` |
| `missing_algorithm1_route_identifiers` | `False` |
| `unsupported_pair_ranked` | `False` |
...
| --- | --- | --- | --- |
| `p5_lgssm_2d_h25_rich` | `kalman_exact` | `APPLICABLE_ORACLE` | linear Gaussian state-space model |
| `p5_lgssm_2d_h25_rich` | `bootstrap_pf_no_resampling_tf` | `APPLICABLE_VALUE_BASELINE` | transition and observation density callbacks are exact |
| `p5_lgssm_2d_h25_rich` | `ledh_pfpf_alg1_ukf_no_resampling_tf` | `APPLICABLE_SOURCE_FAITHFUL_CORE` | all Algorithm 1 callbacks supplied with linear observation Jacobian and exact Gaussian densities |
| `P44 broader model/filter matrix` | `UKF/SVD/CUT4/Zhao-Cui/new Algorithm 1 DPF` | `DEFERRED_PENDING_EXPLICIT_ADAPTERS` | not ranked in this bounded P5 lane; adapters and applicability contracts must be reviewed before broader rows are evidence |
...
- scope: `bounded_initial_p5_lgssm_lane`
- value lane: full 25-observation LGSSM fixture, 3 seeds, particle counts 8/16, no AD gradient tape
- gradient lane: short 3-observation fixed-branch smoke for Algorithm 1 only, seed 101, 4 particles
- full gradient ladder deferred: `True`
- deferred seeds: `[101, 202, 303, 404, 505]`
- deferred particle counts: `[32, 64, 128]`

## Value Summaries

### bootstrap_pf_no_resampling_tf

| Particles | Mean value error | Value SE | Value RMSE | Min ESS |
| ---: | ---: | ---: | ---: | ---: |
| 8 | `-25.119435851765306` | `12.950156657812645` | `31.086961453875332` | `1.0` |
| 16 | `-5.213105017729366` | `2.5872569616628205` | `6.369007858153462` | `1.0000701527841132` |
- diagnostic ranges: `{}`
- particle ladder: `{'value_rmse_reduction_ratio': 0.20487714335167018, 'trend_interpretation': 'diagnostic_only_not_convergence_proof'}`

### ledh_pfpf_alg1_ukf_no_resampling_tf

| Particles | Mean value error | Value SE | Value RMSE | Min ESS |
| ---: | ---: | ---: | ---: | ---: |
| 8 | `-0.8969151895020424` | `0.6547882573389697` | `1.2891672432456134` | `1.0558307246979919` |
| 16 | `-0.5942938691043101` | `0.06430728422601187` | `0.6012121559516416` | `1.2973959514539193` |
- diagnostic ranges: `{'min_forward_log_det': -0.5785997994907275, 'max_forward_log_det': -0.32342311670539936, 'min_predicted_covariance_eigenvalue': 0.12239634175582534, 'max_prediction_floor_count': 0}`
- particle ladder: `{'value_rmse_reduction_ratio': 0.4663569906089353, 'trend_interpretation': 'diagnostic_only_not_convergence_proof'}`

## Gradient Smoke

- method: `ledh_pfpf_alg1_ukf_no_resampling_tf`
- horizon: `3`
- particles: `4`
- value error: `0.2930262849206646`
- fixed-branch gradient: `[0.14421745622487925, -0.08384869142880533]`
- Kalman score: `[-0.4337231845245544, -0.2596045698983306]`
- gradient error norm: `0.6040740956591836`
- relative score error: `0.6040740956591836`
- gradient object: `short_horizon_fixed_branch_smoke`

## Decision Table

| Decision | Primary criterion status | Veto diagnostic status | Main uncertainty | Next justified action | Not concluded |
| --- | --- | --- | --- | --- | --- |
| `PASS_P5_LGSSM_ALG1_UKF_BOUNDED_DIAGNOSTICS_PENDING_CLAUDE_REVIEW` | finite value uncertainty and finite gradient smoke | `{'kalman_reference_nonfinite': False, 'kalman_score_fd_diagnostic_large': False, 'value_row_nonfinite': False, 'gradient_smoke_nonfinite': False, 'missing_value_monte_carlo_uncertainty': False, 'gradient_smoke_mislabeled_stochastic_score': False, 'old_ledh_pfpf_ot_used_as_algorithm1_evidence': False, 'missing_algorithm1_route_identifiers': False, 'unsupported_pair_ranked': False, 'value_pass_used_to_excuse_gradient_failure': False, 'particle_ladder_promoted_to_convergence_proof': False}` | gradient evidence is short-horizon smoke only | run Claude read-only P5 review; then decide whether to add full gradient ladder or P44 adapters | no production, nonlinear/P44, full-gradient-ladder, stochastic-score, or OT-source claim |
...
- command: `CUDA_VISIBLE_DEVICES=-1 MPLCONFIGDIR=/tmp python -m experiments.dpf_implementation.tf_tfp.runners.run_ledh_pfpf_alg1_ukf_p5_lgssm_comparison_tf`
- git branch: `main`
...
- visible GPU devices: `[]`
- value seeds: `[101, 202, 303]`
- value particle counts: `[8, 16]`
- gradient smoke: seed `101`, particles `4`, horizon `3`
- pseudo-time steps: `[0.5, 0.5]`
- UKF parameters: `{'alpha': 1.0, 'beta': 2.0, 'kappa': 0.0}`
- route identifiers: `{'method_generation': 'li_coates_algorithm1_ukf_covariance_lifecycle', 'flow_source_route': 'li_coates_2017_algorithm1_ledh_pfpf', 'covariance_route': 'per_particle_ukf_prediction_update', 'flow_anchor_route': 'zero_noise_transition', 'resampling_route': 'none', 'previous_ledh_pfpf_ot_evidence_status': 'quarantined'}`
- data version: `fixed local LGSSM fixture generated by P5 runner`
- plan: `docs/plans/bayesfilter-dpf-ledh-pfpf-li-coates-alg1-ukf-source-faithful-p5-rerun-comparison-subplan-2026-06-10.md`
- review ledger: `docs/plans/bayesfilter-dpf-ledh-pfpf-li-coates-alg1-ukf-source-faithful-claude-review-ledger-2026-06-10.md`
- JSON: `experiments/dpf_implementation/reports/outputs/dpf_ledh_pfpf_alg1_ukf_p5_lgssm_comparison_2026-06-10.json`
- report: `experiments/dpf_implementation/reports/dpf-ledh-pfpf-alg1-ukf-p5-lgssm-comparison-2026-06-10.md`
- result: `docs/plans/bayesfilter-dpf-ledh-pfpf-li-coates-alg1-ukf-source-faithful-p5-rerun-comparison-result-2026-06-10.md`
- wall time seconds: `95.61245566001162`
