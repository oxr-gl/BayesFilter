...
Status: `PASS_FOR_P1_EVIDENCE_RECORDING_REVIEWED_READY_FOR_P2`.
...
- common-random-number policy: paired seed list is shared across methods and particle counts; each method deterministically maps a seed to stateless initial particles and transition innovations
- branch-freeze policy: fixed-branch score freezes stateless random draws and the realized ESS-triggered OT branch decisions within each row; gradients through random/discrete branch selection are not claimed
- transport branch policy: OT transport is differentiated only for the realized branch; resampling trigger decisions are diagnostics, not differentiated
- gradient object: `fixed_branch_score`
- stochastic score claim: `not_claimed`
...
| `dpf_row_nonfinite` | `False` |
| `missing_evaluator_variance` | `False` |
| `third_particle_trigger_missing` | `False` |
| `fixed_branch_gradient_mislabeled_stochastic_score` | `False` |
...
| --- | --- | --- | --- | --- | --- |
| `PASS_P1_LGSSM_EXACT_ORACLE_READY_FOR_P2` | finite Kalman and DPF rows with value/gradient summaries | `{'kalman_reference_nonfinite': False, 'kalman_score_fd_diagnostic_large': False, 'dpf_row_nonfinite': False, 'missing_evaluator_variance': False, 'third_particle_trigger_missing': False, 'fixed_branch_gradient_mislabeled_stochastic_score': False, 'value_pass_used_to_excuse_gradient_failure': False, 'bf_filterflow_agreement_used_as_oracle': False, 'common_random_number_policy_missing': False, 'branch_freeze_policy_missing': False}` | fixed-branch gradients are not stochastic scores | start P2 tiny nonlinear dense-oracle precheck | no HMC, production, GPU, nonlinear, or stochastic-score claim |

## Claude Review Gate

Iteration 1 returned `VERDICT: REVISE`; Codex accepted and repaired all three
findings: missing gradient evaluator variance, missing common-random-number and
branch-freeze policy, and missing standalone markdown veto/manifest sections.

Iteration 2 returned `VERDICT: AGREE`. Claude found no material P1 blockers
remaining for oracle misuse, fixed-branch overclaim, missing third particle
count, missing evaluator variance, environment mismatch, missing artifacts, or
validator blind spots.

Non-blocking review note: two policy-related veto booleans are hard-coded false
inside `_veto_diagnostics`; this is not a P1 blocker because
`_validate_payload` separately enforces presence of the policy fields.

## Kalman Reference

- log likelihood: `-17.140691771439727`
- score: `[-5.594936987211544, -3.9076975934307616]`
- max score delta vs diagnostic finite difference: `1.4317356455961772e-07`

## Method Summaries

### dpf_bootstrap_ot

| Particles | Mean value error | Value SE | Value RMSE | Score RMSE | Gradient norm SE | Mean relative score error |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 32 | `0.8961992827575728` | `0.31862592878077933` | `1.0996649873397102` | `7.121756520144695` | `1.5626788928787567` | `0.9377047799304826` |
| 64 | `0.9706307598569222` | `0.19315100489029077` | `1.0446785700592038` | `3.49498981774978` | `0.8549705950868528` | `0.4466459984253729` |
| 128 | `0.7822542028258838` | `0.1445548048132311` | `0.8339700259704327` | `3.311843492600966` | `0.561820578906778` | `0.4565046565890657` |
- final gradient mean error: `[2.9583043276638086, 0.3410003572962917]`
- final gradient SE by coordinate: `[0.7061574857343713, 0.16265608050269242]`
- final gradient 95% CI by coordinate: `[[1.5742356556244408, 4.342372999703176], [0.02219443951101452, 0.6598062750815689]]`
- third-particle trigger: `True` reasons `['mean_value_error_ci_excludes_zero_or_row_tolerance_band', 'value_rmse_reduction_less_than_25_percent']`
- interpretation: `P1_DIAGNOSTIC_OR_BIASED_EVIDENCE_PENDING_P5`
- correctness promotion: `not_promoted_in_p1`

### dpf_ledh_pfpf_ot

| Particles | Mean value error | Value SE | Value RMSE | Score RMSE | Gradient norm SE | Mean relative score error |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 32 | `0.2563344046814109` | `0.2905518708707381` | `0.635129030740461` | `2.7351574496280304` | `0.5331479136741158` | `0.3690761021713975` |
| 64 | `0.4106808094798339` | `0.0918568387547561` | `0.44989936939173486` | `1.1239826648761782` | `0.2939281972395606` | `0.14037699552004365` |
| 128 | `0.08210367458404733` | `0.15023326462722864` | `0.3114821802004455` | `1.4723557709307777` | `0.4424529115282028` | `0.1724329499486878` |
- final gradient mean error: `[0.1722785618624437, 0.15789048015646837]`
- final gradient SE by coordinate: `[0.7256194543255169, 0.04221326689883611]`
- final gradient 95% CI by coordinate: `[[-1.2499355686155695, 1.5944926923404568], [0.07515247703474959, 0.24062848327818714]]`
- third-particle trigger: `True` reasons `['mean_value_error_ci_excludes_zero_or_row_tolerance_band']`
- interpretation: `P1_LOCAL_LGSSM_CLOSENESS_EVIDENCE_NOT_PROMOTION`
- correctness promotion: `not_promoted_in_p1`
...
- command: `CUDA_VISIBLE_DEVICES=-1 MPLCONFIGDIR=/tmp python -m experiments.dpf_implementation.tf_tfp.runners.run_filter_oracle_comparison_p1_lgssm_exact_oracle_tf`
- git branch: `main`
...
?? docs/plans/bayesfilter-highdim-zhao-cui-p47-phase2-paper-scale-filtering-claude-review-ledger-2026-06-08.md
...
- particle counts: `[32, 64, 128]`
- data version: `fixed local LGSSM fixture generated by P1 runner`
- plan: `docs/plans/bayesfilter-dpf-filter-oracle-comparison-p1-lgssm-exact-oracle-subplan-2026-06-08.md`
- review ledger: `docs/plans/bayesfilter-dpf-filter-oracle-comparison-p1-claude-review-ledger-2026-06-08.md`
- JSON: `experiments/dpf_implementation/reports/outputs/dpf_filter_oracle_comparison_p1_lgssm_exact_oracle_2026-06-08.json`
- report: `experiments/dpf_implementation/reports/dpf-filter-oracle-comparison-p1-lgssm-exact-oracle-2026-06-08.md`
- result: `docs/plans/bayesfilter-dpf-filter-oracle-comparison-p1-lgssm-exact-oracle-result-2026-06-08.md`
- wall time seconds: `237.02638728404418`
