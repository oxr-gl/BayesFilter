...
Authoritative JSON artifact: `docs/plans/bayesfilter-two-lane-highdim-leaderboard-results-2026-06-30.json`.
...
| zhao_cui_sv_actual_nongaussian_T1000 | ukf | executed_value_only | blocked_autodiff_not_admitted | not_applicable_until_value_score_row_exists | not_applicable_until_value_score_row_exists | not_rankable_correctness_gate_open | -1.460702 | 15.014870 | n/a | actual-SV nonlinear UKF value uses the augmented-noise sigma-point diagnostic route; its current score provenance is autodiff only, so analytical gradient accuracy is not admitted |
| zhao_cui_sv_actual_nongaussian_T1000 | zhao_cui_scalar_or_multistate | executed_value_only | blocked_autodiff_not_admitted | not_applicable_until_value_score_row_exists | not_applicable_until_value_score_row_exists | not_rankable_correctness_gate_open | -0.715097 | 17.155709 | n/a | autodiff score provenance is diagnostic only; analytical gradient accuracy is the leaderboard benchmark |
...
| zhao_cui_sv_ksc_gaussian_mixture_surrogate_T1000 | ukf | executed_value_score | analytical_score_emitted | not_claimed_no_reviewed_batched_main_row_evaluator | not_claimed_no_trusted_row_specific_gpu_xla_manifest | not_ranked_by_phase7_timing | -2.284632 | 108.233614 | n/a | UKF score vector emitted by reviewed principal-square-root analytical component score path |
| zhao_cui_sv_ksc_gaussian_mixture_surrogate_T1000 | zhao_cui_scalar_or_multistate | executed_value_only | blocked_autodiff_not_admitted | not_applicable_until_value_score_row_exists | not_applicable_until_value_score_row_exists | not_rankable_correctness_gate_open | -2.015085 | 22.661457 | n/a | autodiff score provenance is diagnostic only; analytical gradient accuracy is the leaderboard benchmark |
...
| zhao_cui_sv_actual_nongaussian_T1000 | fixed_sgqf, ukf, zhao_cui_scalar_or_multistate | False | none |
| zhao_cui_sv_ksc_gaussian_mixture_surrogate_T1000 | fixed_sgqf, ukf, zhao_cui_scalar_or_multistate | False | none |
| zhao_cui_spatial_sir_austria_j9_T20 | ukf | False | fixed_sgqf, zhao_cui_scalar_or_multistate |
| zhao_cui_predator_prey_T20 | ukf | False | fixed_sgqf, zhao_cui_scalar_or_multistate |
