...
phase: P3
status: PASS_P3_CONDITIONAL_GAUSSIAN_MIXTURE_PENDING_CLAUDE_REVIEW
...
| Field | Contract |
| --- | --- |
| Question | For P0-approved transformed-SV and finite KSC-mixture SV rows, can P3 record same-target value and gradient reference evidence without promoting native-SV or blocked DPF claims? |
| Baseline/comparator | exact transformed dense reference for sv_exact_transformed_log_chi_square_panel; component-enumerated Kalman mixture for sv_ksc_transformed_mixture_panel |
| Primary criterion | same-target reference and candidate rows have finite values, finite reference scores, and route gaps inside local P43/P40 certificate tolerances, with DPF blockers preserved |
| Gradient object | reference_score or fixed_branch_score for theta = (probit(gamma_i), log(beta_i)) per coordinate with sigma fixed |
...
| `jacobian_terms_missing` | `False` |
| `dpf_executed_or_p3_eligible` | `False` |
| `route_target_mismatch` | `False` |
| `gradient_parameterization_mismatch` | `False` |
| `route_row_nonfinite` | `False` |
| `missing_reference_score_or_gap` | `False` |
| `same_target_certificate_tolerance_failed` | `False` |
...
| ---: | ---: | ---: | ---: | ---: | --- |
| 1 | `-4.492112473833502` | `-4.005684672847565e-12` | `3.689717277906871e-15` | `2.523371726816434e-15` | `same_target_certificate_pass` |
| 2 | `-8.81916869084312` | `-8.01136934569513e-12` | `3.1086244689504383e-15` | `1.7309907971102757e-15` | `same_target_certificate_pass` |
| 3 | `-15.033778455609323` | `-1.2017054018542694e-11` | `3.1086244689504383e-15` | `1.2866069076226004e-15` | `same_target_certificate_pass` |
...
| ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | `-4.505481290077734` | `0.0` | `2.3551386880256624e-16` | `1.660458636836547e-16` | `-0.013368816244232029` | `same_target_certificate_pass` |
| 2 | `-8.847218775872449` | `0.0` | `2.4424906541753444e-15` | `1.2154365029145142e-15` | `-0.02805008502932793` | `same_target_certificate_pass` |
| 3 | `-15.092459806872732` | `-5.329070518200751e-15` | `3.3306690738754696e-15` | `1.2901875993693761e-15` | `-0.058681351263409454` | `same_target_certificate_pass` |
...
| --- | --- | ---: | ---: | ---: | --- |
| `zhao_cui_fixed_design_tt` | `CERTIFIED_APPROXIMATION` | `1.2017054018542694e-11` | `3.689717277906871e-15` | `2.523371726816434e-15` | `same_target_fixed_design_tt_local_certificate_not_native_sv_oracle` |
| `cut4` | `CERTIFIED_APPROXIMATION` | `5.329070518200751e-15` | `3.3306690738754696e-15` | `1.2901875993693761e-15` | `same_target_cut4_certificate_for_declared_ksc_mixture_not_native_sv` |

## Approximation Gap

| comparison | max abs value gap | max directional score gap | max relative score error | interpretation |
| --- | ---: | ---: | ---: | --- |
| `ksc_kalman_vs_exact_transformed_dense` | `0.058681351263409454` | `0.03555605677160689` | `0.01412015303109969` | `approximation_only_not_native_sv_promotion` |
...
| --- | --- | --- | --- | --- | --- |
| `PASS_P3_CONDITIONAL_GAUSSIAN_MIXTURE_PENDING_CLAUDE_REVIEW` | exact transformed TT and KSC CUT4 certificates pass for dims `[1, 2, 3]` and `[1, 2, 3]` | `{'native_and_transformed_likelihoods_mixed': False, 'ksc_mixture_called_native_exact_truth': False, 'jacobian_terms_missing': False, 'dpf_executed_or_p3_eligible': False, 'route_target_mismatch': False, 'gradient_parameterization_mismatch': False, 'route_row_nonfinite': False, 'missing_reference_score_or_gap': False, 'same_target_certificate_tolerance_failed': False, 'unsupported_generalized_sv_native_claim': False}` | tiny independent-panel fixture only; sigma-gradient not claimed | run Claude read-only P3 gate review | no DPF, native SV, generalized SV, HMC, production, GPU, or paper-scale claim |
...
- command: `CUDA_VISIBLE_DEVICES=-1 MPLCONFIGDIR=/tmp python -m experiments.dpf_implementation.tf_tfp.runners.run_filter_oracle_comparison_p3_conditional_gaussian_mixture_tf`
- git branch: `main`
...
- visible GPU devices: `[]`
- target ids: `['sv_exact_transformed_log_chi_square_panel', 'sv_ksc_transformed_mixture_panel']`
- dims: `[1, 2, 3]`
- exact dense order/radius: `401`, `8.0`
- KSC transform offset: `1e-08`
- data version: `deterministic P40/P41/P43 transformed-SV fixture`
- plan: `docs/plans/bayesfilter-dpf-filter-oracle-comparison-p3-conditional-gaussian-mixture-subplan-2026-06-08.md`
- review ledger: `docs/plans/bayesfilter-dpf-filter-oracle-comparison-p3-claude-review-ledger-2026-06-08.md`
- JSON: `experiments/dpf_implementation/reports/outputs/dpf_filter_oracle_comparison_p3_conditional_gaussian_mixture_2026-06-08.json`
- report: `experiments/dpf_implementation/reports/dpf-filter-oracle-comparison-p3-conditional-gaussian-mixture-2026-06-08.md`
- result: `docs/plans/bayesfilter-dpf-filter-oracle-comparison-p3-conditional-gaussian-mixture-result-2026-06-08.md`
- wall time seconds: `15.688910223077983`
