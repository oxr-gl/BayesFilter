...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8l-active-all-n10000-it5-2026-06-18.json`
...
- Compile plus first call seconds: `41.52045346098021`
- Warm-call timing summary seconds: `{'min': 20.591378912795335, 'median': 20.591378912795335, 'mean': 20.591378912795335, 'max': 20.591378912795335}`
- Speedup vs scalar comparator: `38.353704593782766`
- Finite output: `True`
