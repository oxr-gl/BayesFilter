...
\paragraph{How to read this section with the toy cases in mind.}
Keep returning mentally to the fully worked 2D examples from the previous
section.  There, we explicitly listed the tensor rules \((1,1)\), \((1,2)\), and
\((2,1)\), and we saw the resulting points.  This section now asks a slower
question: how do we combine such tensor rules systematically, and how do we turn
that combination into one final merged cloud?
