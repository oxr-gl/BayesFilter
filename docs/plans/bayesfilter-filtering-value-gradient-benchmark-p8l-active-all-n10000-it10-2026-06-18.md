...
- JSON artifact: `docs/plans/bayesfilter-filtering-value-gradient-benchmark-p8l-active-all-n10000-it10-2026-06-18.json`
...
- Compile plus first call seconds: `22.55340571096167`
- Warm-call timing summary seconds: `{'min': 9.500685811042786, 'median': 9.500685811042786, 'mean': 9.500685811042786, 'max': 9.500685811042786}`
- Speedup vs scalar comparator: `83.1261742265022`
- Finite output: `True`
