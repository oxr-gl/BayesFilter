...
debugging: rely on the promoted strict-SPD principal-square-root derivative path
for HMC-facing work, and keep the historical eigenderivative SVD-UKF branch as a
diagnostic comparator rather than the production route.
