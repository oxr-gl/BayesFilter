...
part turns to that resampling question directly: first the smallest smooth
surrogate, then deterministic OT equal-weighting, and then the entropic teacher
and its numerical realization.
