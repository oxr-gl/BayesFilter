...
target cloud as cheaply as possible under a declared cost.  This already changes
...
elimination.  The deterministic OT baseline instead asks:
...
solver differentiation are added.
