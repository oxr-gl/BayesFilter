...
\),
then \eqref{eq:bf-hd-sgqf-loglik} is evidence about the intended likelihood only
when the cloud is used inside a same-target direct reweighting path.  The older
