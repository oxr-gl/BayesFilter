...
- Status: `PASS`
- Phase: `paired-gpu:row:low_rank:N=50000`
- Mode: `paired-gpu`
...
- JSON artifact: `docs/benchmarks/scalable-ot-low-rank-ledh-pfpf-efficiency-paired-gpu-2026-06-21-row-low_rank-n50000.json`
