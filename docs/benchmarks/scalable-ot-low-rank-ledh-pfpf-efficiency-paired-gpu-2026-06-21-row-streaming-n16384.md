...
- Status: `PASS`
- Phase: `paired-gpu:row:streaming:N=16384`
- Mode: `paired-gpu`
...
- JSON artifact: `docs/benchmarks/scalable-ot-low-rank-ledh-pfpf-efficiency-paired-gpu-2026-06-21-row-streaming-n16384.json`
