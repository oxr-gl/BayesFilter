...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-p4-streaming-correctness-score-fd-cpu-b2-t3-np4-noresampling-2026-06-16.json`
- Overall passed: `True`
- Shape: `{'batch_size': 2, 'time_steps': 3, 'num_particles': 4, 'state_dim': 1, 'obs_dim': 1, 'parameter_dim': 3}`
...
- no_resampling_score_finite_difference: `True` (promotion_veto)
