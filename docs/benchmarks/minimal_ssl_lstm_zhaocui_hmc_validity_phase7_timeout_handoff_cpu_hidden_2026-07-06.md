...
- Status: `passed`
- Phase decision: `structured_non_promoting_tuning_result_recorded`
- Hard vetoes: `[]`
- Tuning final status: `budget_exhausted`
- Tuning diagnostic role: `phase7_repair_handoff_budget_exhausted_no_attempt_slot`
- Repair triggers: `['trajectory_length_outside_window', 'trajectory_length_above_window', 'acceptance_outside_pass_band', 'phase6_trajectory_status:repair_or_retry', 'phase7_repair_handoff_budget_exhausted_no_attempt_slot']`
...
| Field | Value |
| --- | --- |
| decision | `structured_non_promoting_tuning_result_recorded` |
...
- `windowed_stage`: status `passed`, passed `True`, role `windowed_mass_stage_handoff_only`
- `fixed_mass_step_stage`: status `passed`, passed `True`, role `fixed_mass_step_stage_handoff_only`
- `frozen_step_trajectory_stage`: status `repair_or_retry`, passed `False`, role `repair_trigger`
