...
- JSON artifact: `docs/benchmarks/actual-sir-low-rank-compiled-rerun-p02-grid-2026-06-23-b1-t20-n256-r64-eps0p0625-a1em08-it120-seed81120-routeboth-tpactive-all-stscompiled_core-ltscompiled_core-xla1-si10-seps1p0-as0p9-act0p001-rc128-cc128-pc64-float32-enabled-visible-cuda1.json`
- Status: `PASS`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| streaming | `PASS` | `20` | `20` | `0.1594721465371549` | `0.6290475130081177` | `0.0` | `[]` |
| low_rank | `PASS` | `20` | `20` | `0.08603158395271748` | `0.20777948200702667` | `0.0` | `[]` |

## Paired Comparability

- log_likelihood_max_abs_delta: `17.04644775390625`
- log_likelihood_mean_abs_delta: `17.04644775390625`
- filtered_mean_relative_l2: `0.008998120362100601`
- filtered_mean_rms: `1.5333452481789078`
- filtered_variance_relative_l2: `1.8081861340145593`
- filtered_variance_rms: `2.2848525237451645`
- final_particle_mean_relative_l2: `0.004647327344285332`
- final_particle_mean_abs_l2: `0.5636005028214154`
- warm_median_streaming_over_low_rank: `1.8536465238719768`

## Run Manifest

- Git commit: `01213338c7037c468f38b01d013e4ce13526c9e4`
- Command: `docs/benchmarks/benchmark_actual_sir_low_rank_route_validation.py --route both --streaming-timing-source compiled_core --low-rank-timing-source compiled_core --batch-seeds 81120 --time-steps 20 --num-particles 256 --transport-policy active-all --sinkhorn-iterations 10 --sinkhorn-epsilon 1.0 --annealed-scaling 0.9 --annealed-convergence-threshold 0.001 --row-chunk-size 128 --col-chunk-size 128 --particle-chunk-size 64 --low-rank-rank 64 --low-rank-assignment-epsilon 0.0625 --low-rank-alpha 1e-08 --low-rank-max-projection-iterations 120 --low-rank-convergence-threshold 1e-06 --low-rank-denominator-floor 1e-30 --warmups 1 --repeats 2 --dtype float32 --tf32-mode enabled --device-scope visible --device /GPU:0 --expect-device-kind gpu --phase-id ACTUAL-SIR-LR-TUNING-r64_eps0p0625_alpha1em08_it120 --output docs/benchmarks/actual-sir-low-rank-compiled-rerun-p02-grid-2026-06-23-b1-t20-n256-r64-eps0p0625-a1em08-it120-seed81120-routeboth-tpactive-all-stscompiled_core-ltscompiled_core-xla1-si10-seps1p0-as0p9-act0p001-rc128-cc128-pc64-float32-enabled-visible-cuda1.json --markdown-output docs/benchmarks/actual-sir-low-rank-compiled-rerun-p02-grid-2026-06-23-b1-t20-n256-r64-eps0p0625-a1em08-it120-seed81120-routeboth-tpactive-all-stscompiled_core-ltscompiled_core-xla1-si10-seps1p0-as0p9-act0p001-rc128-cc128-pc64-float32-enabled-visible-cuda1.md --jit-compile --cuda-visible-devices 1`
