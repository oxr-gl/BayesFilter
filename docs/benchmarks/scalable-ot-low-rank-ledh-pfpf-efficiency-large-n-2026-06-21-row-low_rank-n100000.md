...
- Status: `PASS`
- Phase: `large-n:row:low_rank:N=100000`
- Mode: `large-n`
...
- JSON artifact: `docs/benchmarks/scalable-ot-low-rank-ledh-pfpf-efficiency-large-n-2026-06-21-row-low_rank-n100000.json`
