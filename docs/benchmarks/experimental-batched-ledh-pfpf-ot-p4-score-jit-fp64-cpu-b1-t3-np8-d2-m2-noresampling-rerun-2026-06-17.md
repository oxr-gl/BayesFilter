...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-p4-score-jit-fp64-cpu-b1-t3-np8-d2-m2-noresampling-rerun-2026-06-17.json`
- Overall passed: `True`
...
| --- | --- | ---: | ---: | --- |
| original_dense_tensor | True | 7.5072 | 0.0007944358512759209 | `[-0.21649639770032508, -1.1460654231991982, -1.7707907402907987]` |
| streaming_dense_tensor | True | 4.6321 | 0.001868321094661951 | `[-0.21649639770032508, -1.1460654231991985, -1.7707907402907983]` |
| streaming_streaming_tensor | True | 3.77135 | 0.0015200721099972725 | `[-0.21649639770032508, -1.1460654231991985, -1.7707907402907983]` |
| streaming_streaming_equivalent_callback | True | 3.85858 | 0.0018079110886901617 | `[-0.21649639770032508, -1.1460654231991985, -1.7707907402907983]` |
