...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-p3-two-gpu-row-split-gpu0-rows0-1-b2-t20-np256-d10-m10-2026-06-16.json`
...
- Compile plus first call seconds: `10.499087405158207`
- Warm-call timing summary seconds: `{'min': 0.09299129503779113, 'median': 0.09299129503779113, 'mean': 0.09299129503779113, 'max': 0.09299129503779113}`
- Finite output: `True`
