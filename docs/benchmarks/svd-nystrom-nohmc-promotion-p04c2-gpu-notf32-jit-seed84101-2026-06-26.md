...
- JSON artifact: `docs/benchmarks/svd-nystrom-nohmc-promotion-p04c2-gpu-notf32-jit-seed84101-2026-06-26.json`
- Status: `FAIL`
- Phase: `SVD-NYSTROM-NOHMC-PROMOTION-P04C2-GPU-NOTF32-JIT-SEED84101`
...
| --- | --- | ---: | ---: | ---: | --- |
| streaming | `FAIL` | `10.914081313181669` | `0.6418501497246325` | `nan` | `['nonfinite_log_likelihood', 'nonfinite_filtered_means', 'nonfinite_filtered_variances', 'nonfinite_ess_by_time']` |
