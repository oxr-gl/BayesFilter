...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-mixed-precision-hmc-smoke-fp32-tf32-gpu0-b1-t3-np8-d2-m2-active-odd-2026-06-17.json`
- Overall passed: `True`
- Hard veto status: `passed`
- Acceptance rate: `1.0`
- Nonfinite samples: `0`
- Nonfinite log accept ratios: `0`
