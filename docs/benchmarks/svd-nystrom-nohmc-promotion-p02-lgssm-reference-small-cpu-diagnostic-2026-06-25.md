...
- Hard vetoes: `[]`
- JSON artifact: `docs/benchmarks/svd-nystrom-nohmc-promotion-p02-lgssm-reference-small-cpu-diagnostic-2026-06-25.json`

## Rows

| Case | Seed | Route | Status | Mean RMSE | Var RMSE | Loglik delta | Row residual | Vetoes |
| --- | ---: | --- | --- | ---: | ---: | ---: | ---: | --- |
| lgssm_small_exact_ref | 91001 | `svd_nystrom` | `PASS` | 0.12211573668063272 | 0.24272995334353728 | 1.7883644104003906 | 0.0042567127384245396 | `[]` |
