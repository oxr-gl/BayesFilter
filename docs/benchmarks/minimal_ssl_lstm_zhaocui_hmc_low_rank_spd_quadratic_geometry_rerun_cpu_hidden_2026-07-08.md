...
- Tuning diagnostic role: `budget_exhausted_non_promoting`
- Repair triggers: `['screen_acceptance_below_repair_band', 'screen_acceptance_above_repair_band', 'trajectory_length_outside_window', 'trajectory_length_below_window', 'acceptance_outside_pass_band_inside_repair_band', 'joint_l_epsilon_no_viable_pair', 'phase5_fixed_mass_step_status:repair_or_retry', 'phase7_budget_exhausted']`
...
- `fixed_mass_step_stage`: status `repair_or_retry`, passed `False`, role `repair_trigger`
