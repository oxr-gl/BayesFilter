...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-tf32-capacity-gpu0-b1-t120-np10000-d20-m20-activeall-callback-2026-06-15.json`
- Shape: `{'batch_size': 1, 'time_steps': 120, 'num_particles': 10000, 'state_dim': 20, 'obs_dim': 20}`
...
- Compile plus first call seconds: `51.37459196592681`
- Warm-call timing summary seconds: `{'min': 40.28996757417917, 'median': 40.28996757417917, 'mean': 40.28996757417917, 'max': 40.28996757417917}`
- Finite output: `True`
