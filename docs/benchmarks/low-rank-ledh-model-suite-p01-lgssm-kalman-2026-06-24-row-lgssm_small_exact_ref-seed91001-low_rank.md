...
- Hard vetoes: `[]`
- JSON artifact: `docs/benchmarks/low-rank-ledh-model-suite-p01-lgssm-kalman-2026-06-24-row-lgssm_small_exact_ref-seed91001-low_rank.json`

## Rows

| Case | Seed | Route | Status | Mean RMSE | Var RMSE | Loglik delta | Invocations | Vetoes |
| --- | ---: | --- | --- | ---: | ---: | ---: | ---: | --- |
| lgssm_small_exact_ref | 91001 | `low_rank` | `PASS` | 0.12217001485398285 | 0.24310161641213188 | 1.7836189270019531 | 12 | `[]` |
