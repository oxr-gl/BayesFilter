...
- JSON artifact: `docs/benchmarks/actual-sir-low-rank-n3072-second-candidate-validation-2026-06-23-b2-t20-n3072-r16-eps0p125-a1em08-it120-seed81137_81138-routeboth-tpactive-all-stscompiled_core-ltscompiled_core-xla1-si10-seps1p0-as0p9-act0p001-rc128-cc128-pc64-float-h63fd5ec16a683262.json`
- Status: `PASS`
...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| streaming | `PASS` | `20` | `20` | `6.821462829597294` | `0.6319534778594971` | `9.5367431640625e-07` | `[]` |
| low_rank | `PASS` | `20` | `20` | `0.6726877014152706` | `0.6319534778594971` | `9.5367431640625e-07` | `[]` |

## Paired Comparability

- log_likelihood_max_abs_delta: `1.6871337890625`
- log_likelihood_mean_abs_delta: `1.33868408203125`
- filtered_mean_relative_l2: `0.0007172919954221708`
- filtered_mean_rms: `0.12217722478015508`
- filtered_variance_relative_l2: `0.08573564561058275`
- filtered_variance_rms: `0.10966921731842919`
- final_particle_mean_relative_l2: `0.00043105992246831194`
- final_particle_mean_abs_l2: `0.07372980177816275`
- warm_median_streaming_over_low_rank: `10.140608807393965`
