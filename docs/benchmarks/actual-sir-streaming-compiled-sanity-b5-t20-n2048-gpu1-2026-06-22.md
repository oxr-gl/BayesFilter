...
- JSON artifact: `docs/benchmarks/actual-sir-streaming-compiled-sanity-b5-t20-n2048-gpu1-2026-06-22.json`
- Row: `zhao_cui_spatial_sir_austria_j9_T20`
- Shape: `{'batch_size': 5, 'batch_seed_count': 5, 'time_steps': 20, 'num_particles': 2048, 'state_dim': 18, 'obs_dim': 9}`
...
- Compile plus first call seconds: `20.397380776004866`
- Warm-call timing summary seconds: `{'min': 0.29988364898599684, 'median': 0.29988364898599684, 'mean': 0.29988364898599684, 'max': 0.29988364898599684}`
- Speedup vs scalar comparator: `2633.5402636002937`
- Finite output: `True`
