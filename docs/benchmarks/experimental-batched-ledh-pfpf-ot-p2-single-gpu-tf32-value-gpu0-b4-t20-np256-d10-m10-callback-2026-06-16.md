...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-p2-single-gpu-tf32-value-gpu0-b4-t20-np256-d10-m10-callback-2026-06-16.json`
- Shape: `{'batch_size': 4, 'time_steps': 20, 'num_particles': 256, 'state_dim': 10, 'obs_dim': 10}`
...
- Compile plus first call seconds: `10.665356416022405`
- Warm-call timing summary seconds: `{'min': 0.09592609317041934, 'median': 0.09592609317041934, 'mean': 0.09592609317041934, 'max': 0.09592609317041934}`
- Finite output: `True`
