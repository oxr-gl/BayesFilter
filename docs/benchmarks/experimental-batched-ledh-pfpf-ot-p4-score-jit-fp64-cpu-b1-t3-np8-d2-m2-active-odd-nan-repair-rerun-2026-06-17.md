...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-p4-score-jit-fp64-cpu-b1-t3-np8-d2-m2-active-odd-nan-repair-rerun-2026-06-17.json`
- Overall passed: `True`
...
| --- | --- | ---: | ---: | --- |
| original_dense_tensor | True | 7.536 | 0.0008365181274712086 | `[-0.1981248322435411, -1.1501220769486298, -1.7740456265903712]` |
| streaming_dense_tensor | True | 6.22621 | 0.002341022016480565 | `[-0.19812483224354108, -1.1501220769486298, -1.7740456265903708]` |
| streaming_streaming_tensor | True | 13.014 | 0.00807473505847156 | `[-0.1981248322435411, -1.15012207694863, -1.7740456265903708]` |
| streaming_streaming_equivalent_callback | True | 12.3848 | 0.010834936052560806 | `[-0.1981248322435411, -1.15012207694863, -1.7740456265903708]` |
