...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-p5-guardrail-score-jit-fp64-cpu-b1-t3-np8-d2-m2-active-odd-2026-06-17.json`
- Overall passed: `True`
...
| --- | --- | ---: | ---: | --- |
| original_dense_tensor | True | 7.76734 | 0.0011350051499903202 | `[-0.1981248322435411, -1.1501220769486298, -1.7740456265903712]` |
| streaming_dense_tensor | True | 6.1991 | 0.001866810955107212 | `[-0.19812483224354108, -1.1501220769486298, -1.7740456265903708]` |
| streaming_streaming_tensor | True | 13.0014 | 0.007673384854570031 | `[-0.1981248322435411, -1.15012207694863, -1.7740456265903708]` |
| streaming_streaming_equivalent_callback | True | 12.3399 | 0.011093210196122527 | `[-0.1981248322435411, -1.15012207694863, -1.7740456265903708]` |
