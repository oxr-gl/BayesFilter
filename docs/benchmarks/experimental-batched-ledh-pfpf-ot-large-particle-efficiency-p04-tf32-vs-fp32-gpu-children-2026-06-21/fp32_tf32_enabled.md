...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-large-particle-efficiency-p04-tf32-vs-fp32-gpu-children-2026-06-21/fp32_tf32_enabled.json`
...
- Compile plus first call seconds: `25.014469312038273`
- Warm-call timing summary seconds: `{'min': 11.870695133926347, 'median': 11.870695133926347, 'mean': 11.870695133926347, 'max': 11.870695133926347}`
- Finite output: `True`
