...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-large-particle-efficiency-p03-streaming-large-n-gpu-clean-rerun-children-2026-06-21/streaming_tf32_n20000.json`
- Shape: `{'batch_size': 1, 'time_steps': 80, 'num_particles': 20000, 'state_dim': 20, 'obs_dim': 20}`
...
- Compile plus first call seconds: `42.1973754579667`
- Warm-call timing summary seconds: `{'min': 29.24114408181049, 'median': 29.24114408181049, 'mean': 29.24114408181049, 'max': 29.24114408181049}`
- Finite output: `True`
