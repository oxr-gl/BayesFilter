...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-large-particle-efficiency-p03-streaming-large-n-gpu-clean-rerun-children-2026-06-21/streaming_tf32_n1000.json`
- Shape: `{'batch_size': 1, 'time_steps': 80, 'num_particles': 1000, 'state_dim': 20, 'obs_dim': 20}`
...
- Compile plus first call seconds: `13.864507090067491`
- Warm-call timing summary seconds: `{'min': 0.9543289658613503, 'median': 0.9543289658613503, 'mean': 0.9543289658613503, 'max': 0.9543289658613503}`
- Finite output: `True`
