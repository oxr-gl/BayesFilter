...
- JSON artifact: `docs/benchmarks/experimental-batched-ledh-pfpf-ot-large-particle-efficiency-p03-streaming-large-n-gpu-clean-rerun-children-2026-06-21/streaming_tf32_n5000.json`
- Shape: `{'batch_size': 1, 'time_steps': 80, 'num_particles': 5000, 'state_dim': 20, 'obs_dim': 20}`
...
- Compile plus first call seconds: `18.464206242002547`
- Warm-call timing summary seconds: `{'min': 5.236748277908191, 'median': 5.236748277908191, 'mean': 5.236748277908191, 'max': 5.236748277908191}`
- Finite output: `True`
