...
- JSON artifact: `docs/benchmarks/svd-nystrom-nohmc-promotion-p04c2-gpu-notf32-nojit-seed84101-2026-06-26.json`
- Status: `FAIL`
- Phase: `SVD-NYSTROM-NOHMC-PROMOTION-P04C2-GPU-NOTF32-NOJIT-SEED84101`
...
| --- | --- | ---: | ---: | ---: | --- |
| streaming | `FAIL` | `27.72157960990444` | `None` | `None` | `['route_exception']` |
