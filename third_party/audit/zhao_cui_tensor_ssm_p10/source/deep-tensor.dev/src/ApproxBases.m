classdef ApproxBases
    ...
    methods
        ...
        function u = measure_reference_inverse_cdf(obj,z)
            u = zeros(ndims(obj),size(z,2));
            for k = 1:ndims(obj)
                u(k,:) = measure_inverse_cdf(obj.oneds{k},z(k,:));
            end
        end
        ...
        function x = measure_inverse_cdf(obj,z)
            u = measure_reference_inverse_cdf(obj,z);
            x = reference2domain(obj,u);
        end
